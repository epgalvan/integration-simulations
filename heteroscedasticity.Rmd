...
```{r}
load(file = "C:/Users/DELL/Documents/socog/trialCount.RData")
library(pracma)
library(ggplot2)
warp = function(Prediction, WarpFactor, max){
...
for (i in 1:nrow(df)){
  ...
  data$Preds = warp(data$Preds, Factor)
  data$PredsAlt = warp(data$PredsAlt, Factor)
